...
namespace FastMarketRESTAPI.Migrations
{
    ...
    [Migration("20201123012809_added_LineaCredito")]
    partial class added_LineaCredito
    {
            ...
            modelBuilder.Entity("FastMarketRESTAPI.Model.Identity.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "089c5835-ebbc-4074-a5e6-1056102fd313",
                            ConcurrencyStamp = "3a83d193-06c1-4f27-935d-10ed045188ba",
                            Name = "ADMIN",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "0c8fa738-4ef7-4955-9102-4f75d4f33aa7",
                            ConcurrencyStamp = "f0d2b105-82be-40e4-9225-4ec6ae063584",
                            Name = "USER",
                            NormalizedName = "USER"
                        });
                });
